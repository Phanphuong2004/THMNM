...
<div class="container mt-4">
    ...
    <form method="POST" action="/bai3/Product/save" enctype="multipart/form-data" onsubmit="return validateForm();">
    ...
    <div class="text-center mt-3">
        <a href="/bai3/Product/" class="btn btn-outline-success" style="color: #198754; border-color: #198754;">
