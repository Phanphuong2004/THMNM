...
<div class="container mt-4">
    ...
    <form method="POST" action="/bai3/Product/update" enctype="multipart/form-data" onsubmit="return validateForm();">
    ...
    <div class="text-center mt-3">
        <a href="/bai3/Product/list" class="btn btn-outline-primary mt-2" style="color: #0d6efd; border-color: #0d6efd;">
