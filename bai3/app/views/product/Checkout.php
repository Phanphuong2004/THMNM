...
<div class="container mt-4">
    ...
    <form method="POST" action="/bai3/Product/processCheckout">
    ...
    <div class="text-center mt-3">
        <a href="/bai3/Product/cart" class="btn btn-outline-secondary mt-2" style="color: #9C27B0; border-color: #9C27B0;">
