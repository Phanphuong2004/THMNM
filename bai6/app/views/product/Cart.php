...
<div class="container mt-4">
        ...
        <ul class="list-group">
            <?php foreach ($cart as $id => $item): ?>
                <li class="list-group-item shadow-sm mb-3" style="border-left: 5px solid #FF8C00;">
                    ...
                    <?php if ($item['image']): ?>
                        <img src="/bai5/<?php echo $item['image']; ?>" alt="Product Image" style="max-width: 100px; border-radius: 5px; margin-bottom: 10px;">
                    <?php endif; ?>
    ...
    <div class="d-flex justify-content-center mt-4">
        <a href="/bai5/Product" class="btn btn-lg mx-2" style="background-color: #FF8C00; border-color: #FF8C00; color: white;">
            <i class="fas fa-shopping-bag"></i> Tiếp tục mua sắm
        </a>
        <a href="/bai5/Product/checkout" class="btn btn-lg mx-2" style="background-color: #FF8C00; border-color: #FF8C00; color: white;">
